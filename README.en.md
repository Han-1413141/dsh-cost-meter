...
[![version](https://img.shields.io/badge/version-1.7.0-4176E6)](https://github.com/Han-1413141/dsh-cost-meter)
...
**PowerShell one-click script** (copy the whole line, paste, press Enter; pnpm is provisioned automatically, git is auto-detected — no clone needed; the install chain is **pinned to the release tag `v1.7.0`** — review the script before running):
...
```sh
dsh plugin --profile web add github:Han-1413141/dsh-cost-meter#v1.7.0
```

Without git, use the GitHub tag archive:

```sh
dsh plugin --profile web add https://github.com/Han-1413141/dsh-cost-meter/archive/refs/tags/v1.7.0.tar.gz
```
