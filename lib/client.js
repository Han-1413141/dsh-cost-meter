    ...
    function parseConfig(v, path) {
      ...
      return {
        ...
        budget: {
          ...
          period: v.budget?.period === 'day' || v.budget?.period === 'all' ? v.budget.period : 'month',
        },
      }
    }
    ...
    function BudgetPanel(props) {
      ...
      return el('div', { className: 'cm-budget' },
        ...
        budget.enabled
          ...
          : el('p', { className: 'cm-note' }, '未启用预算。启用后此处显示预算额度、已用金额与已用百分比(按当前币种换算)。'))
    }
