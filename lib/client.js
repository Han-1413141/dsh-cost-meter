      ...
      const windowRow = (labelKey, win, main) => {
        ...
        return el('div', { className: 'cm-go-row' + (main ? ' main' : '') },
          ...
          el('div', { className: 'cm-go-bar' },
            percent === null ? null : el('div', { className: 'cm-go-fill', style: { width: percent + '%' } })),
          el('span', { className: 'cm-go-num' }, percent === null ? '—' : t('goQuotaPercent', { percent: String(Math.round(percent)) })),
