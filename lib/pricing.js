...
export const DEFAULT_PROVIDER_PRICE_TABLE = {
  ...
  google: {
    models: {
      'gemini-3.7-flash': { input: 0.75, output: 3.75, billingMode: 'flat', sourceUrl: 'https://ai.google.dev/gemini-api/docs/pricing', checkedAt: '2026-08-17', notes: '2026 年底前促销价;2027 起 $1.5/$7.5;Zen 网关按 $1.5/$7.5' },
  ...
  moonshot: {
    models: {
      'kimi-k3': { input: 3, cachedInput: 0.3, output: 15, billingMode: 'flat', sourceUrl: 'https://opencode.ai/docs/zen', checkedAt: '2026-08-17', notes: '官方人民币价 ¥20/¥100/缓存¥2 每百万;此处为 Zen 网关美元价' },
  ...
  // OpenCode Go 订阅($10/月)包含的全部 18 个模型:订阅制下请求不按 token 扣费,
  ...
  'opencode-go': {
    models: {
      ...
      'deepseek-v4-pro': { input: 0.66, cachedInput: 0.022, output: 1.98, billingMode: 'flat', sourceUrl: 'https://opencode.ai/docs/go', checkedAt: '2026-08-17', notes: 'Go 目录为谷时价参考;官方峰时翻倍' },
      'deepseek-v4-flash': { input: 0.22, cachedInput: 0.007, output: 0.66, billingMode: 'flat', sourceUrl: 'https://opencode.ai/docs/go', checkedAt: '2026-08-17', notes: 'Go 目录为谷时价参考;官方峰时翻倍' },
...
export const PROVIDER_MODEL_FAMILIES = {
  ...
  'opencode-go': {
    ...
    'deepseek-v4-pro': 'DeepSeek V4', 'deepseek-v4-flash': 'DeepSeek V4', 'hy3': 'Hy3',
  },
}
...
function stripIdDecor(id) {
  ...
  // 去掉日期后缀(-2026-01-01 / -20260101 / @2026-01-01)与版本号后缀(-v2 / -1.5)。
 ...
 * 顺序:精确 → 去日期/版本后缀精确 → 候选前缀(取最长) → 家族 token 相似(≥2 个前缀 token 且最长者胜,阈值防误配)。
