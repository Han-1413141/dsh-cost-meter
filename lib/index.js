...
const SERVER_MESSAGES = {
  zh: {
    ...
    goQuotaKeyMissing: '未找到 OpenCode Go API Key。有 Go 订阅的话:运行 opencode login,或在显示设置中填写 Key;没有订阅可关闭上方「启用」开关。',
  ...
  en: {
    ...
    goQuotaKeyMissing: 'OpenCode Go API key not found. If you have a Go subscription: run opencode login, or set the key in Display settings; otherwise turn off the Enable switch above.',
