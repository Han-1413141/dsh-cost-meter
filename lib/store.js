...
const VALIDATION_MESSAGES = {
  zh: {
    ...
    customBalanceHeaders: 'customBalance.request.headers 必须是对象',
  ...
  en: {
    ...
    customBalanceHeaders: 'customBalance.request.headers must be an object',
...
export function applyConfigPatch(current, patch) {
  ...
  if (customBalance !== undefined) {
    if (customBalance === null || typeof customBalance !== 'object' || Array.isArray(customBalance)) {
      ...
      if (request === null || typeof request !== 'object' || Array.isArray(request) || typeof request.url !== 'string' || request.url.length === 0) {
